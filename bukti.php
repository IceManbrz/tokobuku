...
<html lang="en">
  ...
  <body>
    ...
    <div id="myCarousel" class="container carousel slide" data-bs-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          ...
          <img src="../img/caraousel/caraousel1.png">
    ...
    <div class="container pt-5">
      <div class="row pb-3">
        <form action="../admin/prosedur.php" method="post" enctype="multipart/form-data">
        <div class="mb-3">
            <label for="exampleFormControlInput1" class="form-label">Upload Bukti</label>
            <input class="form-control" type="file" name="bukti" id="file1" onchange="loadFile1(event)"><br>
                <center>
                  <img id="output1">
                </center>
        </div>
        <div class="mb-3">
            ...
            <button name="submit_bukti" class="btn btn-primary" >Kirim</button>
        </div>
        </form>
      </div>
    </div>
