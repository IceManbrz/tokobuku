<?php include ('koneksi.php'); 
  ...
  if (isset($_SESSION['id_user'])) {
    $sql_user = mysqli_query($con,"SELECT * FROM user WHERE id_user = '$_SESSION[id_user]' ");
      ...
      <div class="navbar navbar-expand-lg justify-content-between py-3" role="navigation">
        <div class="col-lg-2 px-5">
          <a href="index.php" role="navigation">
            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ6joX3hFgBAEbZeCNLn6t1zabtboY5eOdUZ8US6tC4MA&s" alt="" width="100" />
          </a>
        </div>
        <div class="col-lg-10">
    ...
    <div class="container pt-2">
      <div class="row pb-3 col-md-13">
        ...
        <div class="col-6 col-md-3 mt-4" >
          ...
          <a href="detail.php?pp=<?= $produk['id_produk'] ?>">
            <img src="../admin/assets/img/buku/<?= $produk['gambar_produk'] ?>" class="card-img-top" width="100">
          </a>  
            <div class="card-body">
              <a href="detail.php?pp=<?= $produk['id_produk'] ?>" class="text-dark">
              ...
              <p class="card-text text-center ">
                <?php
                  ...
                  if($nilai == 0){
                    echo "Rp ". number_format($bil1);
                  }
                  else if($nilai > 0){
                    echo "Rp ". number_format($nilai);
                  }
                ?>
                <br>
                <s  class="text-danger" >
              ...
              <!-- <a href="#" class="btn btn-warning col-12 mb-1">Checkout</a> -->
              <?php if (!empty($_SESSION['id_user'])) { ?>
              <form action="../admin/prosedur.php" method="post">
                <input type="hidden" name="qty" min="0" value="1" class="col-md-1" ><br><br>
                <input type="hidden" name="id_user" value="<?= $_SESSION['id_user'] ?>" >
                <input type="hidden" name="id_produk" value="<?= $produk['id_produk'] ?>" >
                <!-- <button type="submit" name="checkout" value="checkout" class="btn btn-warning">checkout</button> -->
                <button type="submit" name="keranjang" value="keranjang" class="btn btn-primary col-12" >Masukkan Keranjang</button>
                
              </form>
              <?php }else{ ?>
                <a href="login.php" class="btn btn-primary col-12" >Masukkan Keranjang</a>
                <?php } ?>
              <!-- <a href="admin/prosedur.php?kk=<?= $produk['id_produk'] ?>" class="btn btn-primary col-12 text-white" title="Masukkan Keranjang " >Masukkan Keranjang</a> -->
            </div>
          </div>
        </div>
        <?php } ?>
